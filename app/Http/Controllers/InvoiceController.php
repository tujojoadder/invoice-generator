...
class InvoiceController extends Controller
{
    ...
    public function getHistoryData(Request $request)
    {
        ...
        <button type="button" class="btn btn-sm btn-danger delete-btn" data-url="' . $deleteUrl . '" data-id="' . $invoice->id . '">
...
{
    // Check and delete logo if not used by any user
    if ($invoice->logo_path) {
        $logoUsedByUser = User::where('company_logo', $invoice->logo_path)->exists();

        if (!$logoUsedByUser && Storage::disk('public')->exists($invoice->logo_path)) {
