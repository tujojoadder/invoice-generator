        ...
        <div class="d-flex align-items-center mb-4 border-bottom border-secondary pb-3">
            <div class="me-2">
                @if (Auth::user()->company_logo)
                    <img src="{{ asset('storage/' . Auth::user()->company_logo) }}" alt="Logo" class="rounded-circle"
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2">
                    <a href="{{ route('profile.show') }}"
                        class="nav-link text-white d-flex align-items-center {{ request()->is('profile') ? 'active fw-bold' : '' }}">
