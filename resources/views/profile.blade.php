    ...
    <div class="container py-3">
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5">
                ...
                <p class="text-center text-muted mb-4">Update your personal and company information</p>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="text-center mt-3">
                            @if (Auth::user()->company_logo)
                                <img id="logoPreview" src="{{ asset('storage/' . Auth::user()->company_logo) }}"
                                    alt="Logo" class="rounded" style="max-height: 100px;">
                            @else
                                <img id="logoPreview" src="" alt="Logo Preview" class="rounded d-none"
