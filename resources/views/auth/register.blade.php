...
<head>
    <meta charset="UTF-8">
    <title>Register | MyCompany</title>
...
<div class="card shadow p-4" style="width: 400px;">
    <div class="text-center mb-4">
        ...
        <p class="text-muted small">Start your free account today</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <input type="text" name="name" placeholder="Enter your company name" class="form-control" value="{{ old('name') }}" required>
            </div>
        </div>
